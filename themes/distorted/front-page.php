...
<div class="full-width-split group">
    <div class="full-width-split__one">
        <div class="full-width-split__inner">
            ...
            while ($homepageEventsQuery->have_posts()) {
                ...
                // Template Part Here
                // ../content-event, ../content-post, ../content-professors, ../content-etc.
                // Good for global search results
    ...
    <div class="full-width-split__two">
        <div class="full-width-split__inner">
            ...
            // Reset the query meta data after creating a custom query. 
            // Necessary if we need to use the standard query or another custom query later.
            // Not really necessary at the end of a template for example.
            wp_reset_postdata();
            ?>
